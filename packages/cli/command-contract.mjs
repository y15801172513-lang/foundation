export const CLI_ROUTE_GROUPS = Object.freeze({
  ...
  projectReadCommands: Object.freeze(['inventory', 'status', 'list', 'explain', 'intent', 'delivery-check', 'resolve-object', 'inspector-plan', 'delivery-identity']),
...
const routes = [
  ...
  {path: ['rules', 'inspect'], options: {'--root': value(true), '--project': value()}, positionals: {min: 0, max: 0}},
  {path: ['workbench', 'open'], options: {'--root': value(true), '--project': value()}, positionals: {min: 0, max: 0}},
  {path: ['install'], options: {'--destination': value(), '--browser': value(), '--choose-destination': flag(), '--journey-id': value(), '--journey-channel': flag()}, positionals: {min: 0, max: 0}},
...
routes.push(
  ...
  {path: ['manager', 'request-plan'], options: {'--operation': value(true), '--parameters-json': value(), '--previous-plan-ref': value(), '--previous-session-id': value()}, positionals: {min: 0, max: 0}},
  {path: ['manager', 'open-manager'], options: {'--plan-ref': value(true), '--journey-channel': flag()}, positionals: {min: 0, max: 0}},
  {path: ['manager', 'status'], options: {'--plan-ref': value(true)}, positionals: {min: 0, max: 0}},
  {path: ['project', 'inventory'], options: {'--project': value(true), '--root': value()}, positionals: {min: 0, max: 0}},
