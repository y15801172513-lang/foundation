...
当前试用版是 [v0.2.15](https://github.com/y15801172513-lang/foundation/releases/tag/v0.2.15)，配套 [npm 0.1.9](https://www.npmjs.com/package/@josephyulei/summon-foundation/v/0.1.9)。默认使用 Codex 内置浏览器，系统浏览器仅在告知并同意后备用；新对话持续等待与主动告知仍须真人验收。完整流程见[安装说明](docs/install-with-codex.md)。
